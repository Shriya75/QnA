	 ...
	 *	@desc 		
	 *	@file 		screen_7
	 *	@date 		Saturday 07th of October 2023 08:09:33 AM
	 *	@title 		Page 1
	 *	@author 	
	 *	@keywords 	
...
public class screen_7_activity extends Activity {

	
	private View _bg__screen_7_ek2;
	private ImageView __img___freebg_screen_7;
	...
	private ImageView frame_56;
	private ImageView frame_59;
	...
	private View _bg__group_155_ek1;
	private View _bg__frame_64_ek1;
	private ImageView blue_robot_mascot_logo_icon_design_675467_55_1__traced___1__ek1;
	private ImageView frame_58;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_bg__screen_7_ek2 = (View) findViewById(R.id._bg__screen_7_ek2);
		__img___freebg_screen_7 = (ImageView) findViewById(R.id.__img___freebg_screen_7);
		...
		//frame_56 = (ImageView) findViewById(R.id.frame_56);
		frame_59 = (ImageView) findViewById(R.id.frame_59);
		...
		//_bg__group_155_ek1 = (View) findViewById(R.id._bg__group_155_ek1);
		_bg__frame_64_ek1 = (View) findViewById(R.id._bg__frame_64_ek1);
		blue_robot_mascot_logo_icon_design_675467_55_1__traced___1__ek1 = (ImageView) findViewById(R.id.blue_robot_mascot_logo_icon_design_675467_55_1__traced___1__ek1);
		frame_58 = (ImageView) findViewById(R.id.frame_58);
		...
		deleteButton = findViewById(R.id.delchat_button);
		...
		ProfileButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(screen_7_activity.this, screen_9_activity.class);
		...
		history_button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Add your code to navigate to the next screen or perform an action
				// For example, you can start a new activity
				Intent intent = new Intent(screen_7_activity.this, screen_8_activity.class);
				startActivity(intent);
			}
		});
		...
		deleteButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Add your code to navigate to the next screen or perform an action
				// For example, you can start a new activity
				Intent intent = new Intent(screen_7_activity.this, screen_11_activity.class);
				startActivity(intent);
			}
		});
	}
